...
![](https://images.velog.io/images/effypark/post/8b314067-63c4-4016-9b25-173b00cf31ac/image.png)
...
![](https://images.velog.io/images/effypark/post/98f1272d-eabe-4484-b1d0-d0bea28c3cc5/image.png)
...
- 보다 튼튼한 객체 지향적인 코드 생산 : TDD 는 **코드 재사용 보장**을 명시하므로 TDD 를 통해 소프트웨어 개발 시 기능별 철저한 **모듈화**가 이루어진다.
